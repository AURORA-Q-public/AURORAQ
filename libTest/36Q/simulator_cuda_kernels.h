...
__global__ void ApplyGateH_Kernel(
  ...
  __shared__ idx_type shared_global_gpu_id; 
...
__global__ void ApplyControlledGateH_Kernel(
  ...
  printf(" ApplyControlledGateH_Kernel\n");

    
      //printf(" Simulator_cuda_kernel-ApplyControlledGateH_Kernel start\n");
...
__global__ void ApplyControlledGateLH_Kernel(
  ...
  printf(" ApplyControlledGateLH_Kernel\n");

 //printf(" Simulator_cuda_kernel-ApplyControlledGateLH_Kernel start\n");
  static_assert(G < 7, "gates acting on more than 6 qubits are not supported.");
...
__global__ void ApplyControlledGateL_Kernel(
    ...
    fp_type* __restrict__ rstate) {
  // blockDim.x must be equal to 32.
  printf(" ApplyControlledGateL_Kernel\n");
    
          //printf(" Simulator_cuda_kernel-ApplyControlledGateL_Kernel start\n");
...
__global__ void ExpectationValueH_Kernel(
  ...
  // blockDim.x must be equal to 64.
          //printf(" Simulator_cuda_kernel-ExpectationValueH_Kernel start\n");
  printf(" ExpectationValueH_Kernel\n");
...
__global__ void ExpectationValueL_Kernel(
    ...
    const fp_type* __restrict__ rstate, Op op, cfp_type* __restrict__ result) {
  // blockDim.x must be equal to 32.
          //printf(" Simulator_cuda_kernel-ExpectationValueL_Kernel start\n");
  printf(" ExpectationValueL_Kernel\n");
  static_assert(G < 7, "gates acting on more than 6 qubits are not supported.");
